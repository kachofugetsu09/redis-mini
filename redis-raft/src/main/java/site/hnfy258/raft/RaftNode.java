...
public class RaftNode {
    ...
    // 超时时间配置 - 为真实网络环境优化
    private final int MIN_ELECTION_TIMEOUT = 2000; // ms - 增加到2秒，为大型集群提供更稳定的选举时间
    private final int MAX_ELECTION_TIMEOUT = 4000; // ms - 增加到4秒，增加随机性以减少选举冲突
    private final int HEARTBEAT_INTERVAL = 80; // ms - 降低到80ms，确保心跳足够频繁
