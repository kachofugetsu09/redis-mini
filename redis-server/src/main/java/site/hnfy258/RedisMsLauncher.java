...
public class RedisMsLauncher {
    public static void main(String[] args) throws Exception {
        RedisMiniServer masterServer = new RedisMiniServer("localhost", 6379);
        ...
        RedisMiniServer slaveServer1 = new RedisMiniServer("localhost", 6380,"slave1.rdb");
        RedisNode slaveNode1 = new RedisNode(slaveServer1, "localhost", 6380, false, "slave-node1");
        slaveServer1.setRedisNode(slaveNode1);
        slaveServer1.start();

        RedisMiniServer slaveServer2 = new RedisMiniServer("localhost", 6381,"slave2.rdb");
